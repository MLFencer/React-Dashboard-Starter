...
class FormMask extends Component {
  ...
  render() {
    const ISBN1 = (props) => (
      <InputMask mask={/\d+/} value={props.value} className="form-control input-color" onChange={props.onChange}>
    ...
    const TAX = (props) => (
      <InputMask mask="99-9999999" value={props.value} className="form-control input-color" onChange={props.onChange}>
        {(inputProps) => <MaterialInput {...inputProps} type="tel" disableUnderline />}
      </InputMask>
    );
    ...
    const Date1 = (props) => (
      <InputMask mask="99/99/9999" value={props.value} className="form-control input-color" onChange={props.onChange}>
        {(inputProps) => <MaterialInput {...inputProps} type="tel" disableUnderline />}
      </InputMask>
    );
