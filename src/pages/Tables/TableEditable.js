...
const products = [
  { id: 1, age: 25, qty: 1500, cost: 1000, isTrue: true },
...
const columns = [
  {
    ...
    formatter: (value, row) => (
      <span>
        {value}
        {row.isTrue && <span> [ALERT-ICON]</span>}
      </span>
    ),
  },
  {
              ...
              <Card>
                <CardBody>
                  <p className="card-title-desc">
                    Value of the input will be updated on press enter key. It will not update inputs value on blur of
                    input.
                  </p>
                  <BootstrapTable
                    keyField="id"
